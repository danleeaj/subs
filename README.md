...
* Make the program more modularized. I would like the prompts to exist in a separate `prompt.py` so in the future we can iterate upon the prompts more easily and keep a record of all previous prompts.
